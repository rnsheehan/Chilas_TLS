...
def Chils_Ctrl_Hacking():
    ...
    try:
        ...
        instr_obj = serial.Serial(ChilasPort, baudRate, timeout = readTimeout, write_timeout = writeTimeout, stopbits = serial.STOPBITS_ONE, parity = serial.PARITY_NONE)
        
        # Both these commands must execute successfully
